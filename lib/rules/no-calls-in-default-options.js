/**
 * @fileoverview Rule to flag when a call expression is used within the default options object
 */
                ...
                if (current.type === 'ObjectExpression') {
                    ...
                    if (variable.key.name === 'defaultOptions' || variable.key.name === 'options') {
                        if (variable.parent &&
                            ...
                            context.report(node, 'Function call not allowed within the defaultOptions or options object');
                            break;
                        }
                    }
                }
